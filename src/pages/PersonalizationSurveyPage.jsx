...
const PersonalizationSurveyPage = ({ onComplete }) => {
  ...
  const canComplete =
    canMoveNext && status !== "" && skinConcerns.length > 0;
    ...
    <SurveyContainer>
      <SurveyContent>
        ...
        {step === 1 ? (
          <>
            <SurveyHeader>
              <SurveyTitle>여행자님을 환영합니다!</SurveyTitle>
              <SurveyDescription>
                여행자님을 부를 이름을 알려 주세요.
              </SurveyDescription>
            </SurveyHeader>

            <SurveyForm onSubmit={(event) => event.preventDefault()}>
              <FieldGroup>
          ...
          <>
            <SurveyHeader>
              <SurveyTitle>여행자님에 대해 알려 주세요</SurveyTitle>
              <SurveyDescription>
            ...
            <SurveyForm onSubmit={(event) => event.preventDefault()}>
              <Section>
                <SectionTitle>현재 나의 상태</SectionTitle>
                <StatusOptions>
